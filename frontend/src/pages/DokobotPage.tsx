...
export default function DokobotPage() {
  ...
  return (
    <PageShell title="Dokobot" subtitle="智能网页浏览与搜索代理" icon={<RobotOutlined />}>
      ...
      >
        ...
        >
          ...
          <Button type="primary" icon={<GlobalOutlined />} onClick={handleBrowse} disabled={!available}>
            浏览
          </Button>
        </Card>
        ...
        >
          ...
          />
          <Button type="primary" icon={<SearchOutlined />} onClick={handleSearch} disabled={!available}>
            搜索
          </Button>
        </Card>
        ...
        >
          <Input placeholder="URL" value={url} onChange={(e) => setUrl(e.target.value)} style={{ marginBottom: 12 }} />
          <Button icon={<CameraOutlined />} onClick={handleScreenshot} disabled={!available}>
            截图
          </Button>
        </Card>
      </div>
